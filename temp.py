...
def parseArg():
    global title, displayClock, noFrame
...
def triggerAnimation():
    ...
    animation = True
    angle = 0
    pygame.time.set_timer(ANIMATION, ANIMATION_DELAY)
...
# Create time event for animation
...
try:
    ...
    client = mqtt.Client("TEMPERATURE-MQTT {}".format(hostname))
